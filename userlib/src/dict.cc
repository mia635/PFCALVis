//
// File generated by rootcint at Sat Jun 25 01:24:28 2016
...
void HGCSSEvent::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "steelThick_", &steelThick_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "dep_", &dep_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "wgtDep_", &wgtDep_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "seeds_", &seeds_);
      R__insp.InspectMember(seeds_, "seeds_.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "status_", &status_);
      R__insp.InspectMember(status_, "status_.");
}
...
void HGCSSSamplingSection::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "sensDep_", &sensDep_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "absorberDep_", &absorberDep_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "totalNonIonE_", &totalNonIonE_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "totalRawE_", &totalRawE_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "gamFrac_", &gamFrac_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "eleFrac_", &eleFrac_);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "eleKin_", &eleKin_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "gamKin_", &gamKin_);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "gamCount_", &gamCount_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "eleCount_", &eleCount_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "eleShowerSize_", &eleShowerSize_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "hadShowerSize_", &hadShowerSize_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "neutShowerSize_", &neutShowerSize_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "muShowerSize_", &muShowerSize_);
...
void HGCSSGenParticle::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "parentPdgId_", &parentPdgId_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "trackID_", &trackID_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vertexKE_", &vertexKE_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "parentKE_", &parentKE_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "finalKE_", &finalKE_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vertexPos_", &vertexPos_);
      R__insp.InspectMember(vertexPos_, "vertexPos_.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vertexMom_", &vertexMom_);
      R__insp.InspectMember(vertexMom_, "vertexMom_.");
}
...
{
      G__letdouble(result7, 100, (double) ((const HGCSSEvent*) G__getstructoffset())->steelThick());
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__dict_456_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         const TVector3* pobj;
         const TVector3 xobj = ((const HGCSSEvent*) G__getstructoffset())->seeds();
...
static int G__dict_456_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         const TVector3* pobj;
         const TVector3 xobj = ((const HGCSSEvent*) G__getstructoffset())->status();
         pobj = new TVector3(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
{
      G__letdouble(result7, 100, (double) ((const HGCSSEvent*) G__getstructoffset())->dep());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_456_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((HGCSSEvent*) G__getstructoffset())->wgtDep());
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSEvent*) G__getstructoffset())->steelThick((const double) G__double(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSEvent*) G__getstructoffset())->seeds(*((TVector3*) G__int(libp->para[0])));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSEvent*) G__getstructoffset())->status(*((TVector3*) G__int(libp->para[0])));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSEvent*) G__getstructoffset())->dep((double) G__double(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSEvent*) G__getstructoffset())->wgtDep((double) G__double(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__dict_456_0_31(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
// automatic copy constructor
static int G__dict_456_0_32(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__dict_456_0_33(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G__dict_456_0_34(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
{
      G__letint(result7, 104, (long) ((HGCSSSamplingSection*) G__getstructoffset())->gamCount());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_457_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((const HGCSSSamplingSection*) G__getstructoffset())->eleCount());
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      G__letdouble(result7, 100, (double) ((HGCSSSamplingSection*) G__getstructoffset())->eleShowerSize());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_457_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((HGCSSSamplingSection*) G__getstructoffset())->hadronShowerSize());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_457_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((HGCSSSamplingSection*) G__getstructoffset())->neutronShowerSize());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_457_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((HGCSSSamplingSection*) G__getstructoffset())->muShowerSize());
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->sensDep(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->absorberDep(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->totalDep(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->totalNonIonDep(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->gamDepFrac(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->eleDepFrac(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->muDepFrac(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->neutronDepFrac(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->hadDepFrac(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->muKinFlux(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->neutronKinFlux(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->hadKinFlux(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->gamKinFlux(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->eleKinFlux(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->eleShowerSize(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->hadronShowerSize(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->neutronShowerSize(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->muShowerSize(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->gamCount(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((HGCSSSamplingSection*) G__getstructoffset())->eleCount(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__dict_457_0_61(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HGCSSSamplingSection::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_457_0_62(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) HGCSSSamplingSection::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_457_0_63(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_457_0_64(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const HGCSSSamplingSection*) G__getstructoffset())->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_457_0_65(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_457_0_66(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_457_0_67(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_457_0_68(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HGCSSSamplingSection::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_457_0_69(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) HGCSSSamplingSection::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_457_0_70(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HGCSSSamplingSection::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_457_0_71(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
// automatic copy constructor
static int G__dict_457_0_72(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__dict_457_0_73(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G__dict_457_0_74(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
/* HGCSSSimHit */
static int G__dict_602_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   HGCSSSimHit* p = NULL;
   char* gvp = (char*) G__getgvp();
   int n = G__getaryconstruct();
...
static int G__dict_602_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   HGCSSSimHit* p = NULL;
   char* gvp = (char*) G__getgvp();
   switch (libp->paran) {
...
static int G__dict_602_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSSimHit*) G__getstructoffset())->energy());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSSimHit*) G__getstructoffset())->time());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_602_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((const HGCSSSimHit*) G__getstructoffset())->layer());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((const HGCSSSimHit*) G__getstructoffset())->silayer());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_602_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((const HGCSSSimHit*) G__getstructoffset())->cellid());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((const HGCSSSimHit*) G__getstructoffset())->nGammas());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((const HGCSSSimHit*) G__getstructoffset())->nElectrons());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((const HGCSSSimHit*) G__getstructoffset())->nMuons());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((const HGCSSSimHit*) G__getstructoffset())->nNeutrons());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((const HGCSSSimHit*) G__getstructoffset())->nProtons());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((const HGCSSSimHit*) G__getstructoffset())->nHadrons());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((const HGCSSSimHit*) G__getstructoffset())->numberOfParticles());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSSimHit*) G__getstructoffset())->gFrac());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSSimHit*) G__getstructoffset())->eFrac());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSSimHit*) G__getstructoffset())->muFrac());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSSimHit*) G__getstructoffset())->neutronFrac());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSSimHit*) G__getstructoffset())->protonFrac());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSSimHit*) G__getstructoffset())->hadFrac());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_602_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__dict_602_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__dict_602_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSSimHit*) G__getstructoffset())->get_z());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_602_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_602_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_602_0_30(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((const HGCSSSimHit*) G__getstructoffset())->getGranularity());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_31(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const HGCSSSimHit*) G__getstructoffset())->mainParentTrackID());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_32(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSSimHit*) G__getstructoffset())->mainParentEfrac());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_33(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_602_0_34(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) HGCSSSimHit::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_35(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HGCSSSimHit::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_36(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) HGCSSSimHit::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_37(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_602_0_38(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const HGCSSSimHit*) G__getstructoffset())->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_39(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_602_0_40(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_602_0_41(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_602_0_42(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HGCSSSimHit::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_43(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) HGCSSSimHit::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_44(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HGCSSSimHit::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_602_0_45(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
// automatic copy constructor
static int G__dict_602_0_46(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__dict_602_0_47(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G__dict_602_0_48(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_604_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_604_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 107, (long) ((const vector<HGCSSSimHit,allocator<HGCSSSimHit> >*) G__getstructoffset())->capacity());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_604_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_604_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_604_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__dict_604_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__dict_604_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_604_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_604_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<HGCSSSimHit,allocator<HGCSSSimHit> >::iterator* pobj;
...
static int G__dict_604_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_604_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_604_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_604_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_604_0_30(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_604_0_31(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_604_0_32(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
static int G__dict_607_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_607_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const HGCSSGenParticle*) G__getstructoffset())->layer());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSGenParticle*) G__getstructoffset())->pt());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
{
      G__letdouble(result7, 100, (double) ((HGCSSGenParticle*) G__getstructoffset())->parentPdgId());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((HGCSSGenParticle*) G__getstructoffset())->parentKE());
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__dict_607_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_607_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_607_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_607_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_607_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((HGCSSGenParticle*) G__getstructoffset())->vertexKE(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((HGCSSGenParticle*) G__getstructoffset())->finalKE(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_30(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((HGCSSGenParticle*) G__getstructoffset())->vertexPos(*(TVector3*) libp->para[0].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_31(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((HGCSSGenParticle*) G__getstructoffset())->vertexMom(*(TVector3*) libp->para[0].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_32(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_607_0_33(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_607_0_34(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((HGCSSGenParticle*) G__getstructoffset())->parentPdgId(*(int*) G__Intref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_35(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((HGCSSGenParticle*) G__getstructoffset())->parentKE(*(int*) G__Intref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_36(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSGenParticle*) G__getstructoffset())->vertexKE());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_37(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSGenParticle*) G__getstructoffset())->finalKE());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_38(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         TVector3* pobj;
         TVector3 xobj = ((HGCSSGenParticle*) G__getstructoffset())->vertexPos();
         pobj = new TVector3(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
static int G__dict_607_0_39(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         TVector3* pobj;
         TVector3 xobj = ((HGCSSGenParticle*) G__getstructoffset())->vertexMom();
         pobj = new TVector3(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
static int G__dict_607_0_40(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((const HGCSSGenParticle*) G__getstructoffset())->isIncoming());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_41(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_607_0_42(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_607_0_43(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) HGCSSGenParticle::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_44(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HGCSSGenParticle::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_45(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) HGCSSGenParticle::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_46(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_607_0_47(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const HGCSSGenParticle*) G__getstructoffset())->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_48(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_607_0_49(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_607_0_50(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_607_0_51(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HGCSSGenParticle::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_52(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) HGCSSGenParticle::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_53(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HGCSSGenParticle::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_607_0_54(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
// automatic copy constructor
static int G__dict_607_0_55(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__dict_607_0_56(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G__dict_607_0_57(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
/* HGCSSRecoHit */
static int G__dict_612_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   HGCSSRecoHit* p = NULL;
   char* gvp = (char*) G__getgvp();
   int n = G__getaryconstruct();
...
static int G__dict_612_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   HGCSSRecoHit* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 3
...
static int G__dict_612_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSRecoHit*) G__getstructoffset())->energy());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSRecoHit*) G__getstructoffset())->time());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSRecoHit*) G__getstructoffset())->eta());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSRecoHit*) G__getstructoffset())->theta());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSRecoHit*) G__getstructoffset())->phi());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         const ROOT::Math::XYZPoint* pobj;
...
static int G__dict_612_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSRecoHit*) G__getstructoffset())->E());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSRecoHit*) G__getstructoffset())->pt());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSRecoHit*) G__getstructoffset())->px());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSRecoHit*) G__getstructoffset())->py());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSRecoHit*) G__getstructoffset())->pz());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_612_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_612_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_612_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_612_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_612_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((const HGCSSRecoHit*) G__getstructoffset())->adcCounts());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_612_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((const HGCSSRecoHit*) G__getstructoffset())->layer());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_612_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSRecoHit*) G__getstructoffset())->noiseFraction());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_612_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_612_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSRecoHit*) G__getstructoffset())->get_x());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSRecoHit*) G__getstructoffset())->get_y());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const HGCSSRecoHit*) G__getstructoffset())->get_z());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_612_0_30(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) HGCSSRecoHit::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_31(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HGCSSRecoHit::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_32(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) HGCSSRecoHit::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_33(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_612_0_34(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const HGCSSRecoHit*) G__getstructoffset())->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_35(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_612_0_36(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_612_0_37(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_612_0_38(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HGCSSRecoHit::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_39(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) HGCSSRecoHit::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_40(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HGCSSRecoHit::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_612_0_41(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
// automatic copy constructor
static int G__dict_612_0_42(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__dict_612_0_43(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G__dict_612_0_44(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_619_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__dict_619_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__dict_619_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__dict_619_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::iterator* pobj;
...
static int G__dict_619_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__dict_619_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::reverse_iterator* pobj;
...
static int G__dict_619_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 107, (long) ((const vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >*) G__getstructoffset())->size());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_619_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 107, (long) ((const vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >*) G__getstructoffset())->max_size());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_619_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_619_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_619_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 107, (long) ((const vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >*) G__getstructoffset())->capacity());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_619_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((const vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >*) G__getstructoffset())->empty());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_619_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__dict_619_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__dict_619_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_619_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >* p = NULL;
   char* gvp = (char*) G__getgvp();
   switch (libp->paran) {
...
static int G__dict_619_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__dict_619_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 2
...
static int G__dict_619_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__dict_619_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_619_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__dict_619_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__dict_619_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_619_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_619_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::iterator* pobj;
...
static int G__dict_619_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_619_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_619_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_619_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_619_0_30(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_619_0_31(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_619_0_32(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
static void G__setup_memvarHGCSSEvent(void) {
   ...
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"steelThick_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"dep_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"wgtDep_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_TVector3),-1,-1,4,"seeds_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_TVector3),-1,-1,4,"status_=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__dictLN_TClass),-1,-2,4,"fgIsA=",0,(char*)NULL);
   G__memvar_setup((void*)0,108,0,0,-1,-1,-1,4,"G__virtualinfo=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
...
static void G__setup_memvarHGCSSSamplingSection(void) {
   ...
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"sensDep_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"absorberDep_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"totalNonIonE_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"totalRawE_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"gamFrac_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"eleFrac_=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"eleKin_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"gamKin_=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,104,0,0,-1,-1,-1,4,"gamCount_=",0,(char*)NULL);
   G__memvar_setup((void*)0,104,0,0,-1,-1,-1,4,"eleCount_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"eleShowerSize_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"hadShowerSize_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"neutShowerSize_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"muShowerSize_=",0,(char*)NULL);
...
static void G__setup_memvarHGCSSGenParticle(void) {
   ...
   G__memvar_setup((void*)0,105,0,0,-1,-1,-1,4,"parentPdgId_=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,-1,-1,4,"trackID_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"vertexKE_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"parentKE_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"finalKE_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_TVector3),-1,-1,4,"vertexPos_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_TVector3),-1,-1,4,"vertexMom_=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__dictLN_TClass),-1,-2,4,"fgIsA=",0,(char*)NULL);
   G__memvar_setup((void*)0,108,0,0,-1,-1,-1,4,"G__virtualinfo=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
...
static void G__setup_memfuncHGCSSEvent(void) {
   ...
   G__memfunc_setup("HGCSSEvent",890,G__dict_456_0_1, 105, G__get_linked_tagnum(&G__dictLN_HGCSSEvent), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("eventNumber",1163,G__dict_456_0_2, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("eventNumber",1163,G__dict_456_0_3, 121, -1, -1, 0, 1, 1, 1, 0, "h - - 10 - -", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vtx_x",569,G__dict_456_0_4, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("steelThick",1040,G__dict_456_0_5, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vtx_x",569,G__dict_456_0_6, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 10 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vtx_y",570,G__dict_456_0_7, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("seeds",532,G__dict_456_0_8, 117, G__get_linked_tagnum(&G__dictLN_TVector3), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("status",676,G__dict_456_0_9, 117, G__get_linked_tagnum(&G__dictLN_TVector3), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("dep",313,G__dict_456_0_10, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("wgtDep",619,G__dict_456_0_11, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vtx_y",570,G__dict_456_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 10 - y", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vtx_z",571,G__dict_456_0_13, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vtx_z",571,G__dict_456_0_14, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 10 - z", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("steelThick",1040,G__dict_456_0_15, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 10 - thick", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("seeds",532,G__dict_456_0_16, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TVector3' - 0 - seeds", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("status",676,G__dict_456_0_17, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TVector3' - 0 - status", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("dep",313,G__dict_456_0_18, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 0 - dep", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("wgtDep",619,G__dict_456_0_19, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 0 - wgtDep", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__dict_456_0_20, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&HGCSSEvent::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__dict_456_0_21, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSEvent::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__dict_456_0_22, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&HGCSSEvent::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__dict_456_0_23, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&HGCSSEvent::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,G__dict_456_0_24, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,G__dict_456_0_25, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,G__dict_456_0_26, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__dict_456_0_27, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__dict_456_0_28, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSEvent::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__dict_456_0_29, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HGCSSEvent::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__dict_456_0_30, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSEvent::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__dict_456_0_31, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HGCSSEvent::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("HGCSSEvent", 890, G__dict_456_0_32, (int) ('i'), G__get_linked_tagnum(&G__dictLN_HGCSSEvent), -1, 0, 1, 1, 1, 0, "u 'HGCSSEvent' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~HGCSSEvent", 1016, G__dict_456_0_33, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_456_0_34, (int) ('u'), G__get_linked_tagnum(&G__dictLN_HGCSSEvent), -1, 1, 1, 1, 1, 0, "u 'HGCSSEvent' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncHGCSSSamplingSection(void) {
   ...
   G__memfunc_setup("HGCSSSamplingSection",1928,G__dict_457_0_1, 105, G__get_linked_tagnum(&G__dictLN_HGCSSSamplingSection), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("volNb",513,G__dict_457_0_2, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("volX0trans",1025,G__dict_457_0_3, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("voldEdx",726,G__dict_457_0_4, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("volLambdatrans",1466,G__dict_457_0_5, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("sensDep",722,G__dict_457_0_6, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("absorberDep",1129,G__dict_457_0_7, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("totalDep",829,G__dict_457_0_8, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("totalNonIonDep",1422,G__dict_457_0_9, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("gamDepFrac",970,G__dict_457_0_10, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("eleDepFrac",971,G__dict_457_0_11, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("muDepFrac",887,G__dict_457_0_12, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("neutronDepFrac",1440,G__dict_457_0_13, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("hadDepFrac",962,G__dict_457_0_14, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("neutronKinFlux",1484,G__dict_457_0_15, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("muKinFlux",931,G__dict_457_0_16, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("hadKinFlux",1006,G__dict_457_0_17, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("eleKinFlux",1015,G__dict_457_0_18, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("gamKinFlux",1014,G__dict_457_0_19, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("muCount",747,G__dict_457_0_20, 104, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("hadCount",822,G__dict_457_0_21, 104, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("neutronCount",1300,G__dict_457_0_22, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("gamCount",830,G__dict_457_0_23, 104, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("eleCount",831,G__dict_457_0_24, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("avgTime",717,G__dict_457_0_25, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("eleShowerSize",1353,G__dict_457_0_26, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("hadronShowerSize",1679,G__dict_457_0_27, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("neutronShowerSize",1822,G__dict_457_0_28, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("muShowerSize",1269,G__dict_457_0_29, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("nSiHits",706,G__dict_457_0_30, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("volNb",513,G__dict_457_0_31, 121, -1, -1, 0, 1, 1, 1, 0, "h - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("volX0trans",1025,G__dict_457_0_32, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("voldEdx",726,G__dict_457_0_33, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("volLambdatrans",1466,G__dict_457_0_34, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("sensDep",722,G__dict_457_0_35, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("absorberDep",1129,G__dict_457_0_36, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("totalDep",829,G__dict_457_0_37, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("totalNonIonDep",1422,G__dict_457_0_38, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("gamDepFrac",970,G__dict_457_0_39, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("eleDepFrac",971,G__dict_457_0_40, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("muDepFrac",887,G__dict_457_0_41, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("neutronDepFrac",1440,G__dict_457_0_42, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("hadDepFrac",962,G__dict_457_0_43, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("avgTime",717,G__dict_457_0_44, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("nSiHits",706,G__dict_457_0_45, 121, -1, -1, 0, 1, 1, 1, 0, "h - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("muKinFlux",931,G__dict_457_0_46, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("neutronKinFlux",1484,G__dict_457_0_47, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("hadKinFlux",1006,G__dict_457_0_48, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("gamKinFlux",1014,G__dict_457_0_49, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("eleKinFlux",1015,G__dict_457_0_50, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("eleShowerSize",1353,G__dict_457_0_51, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("hadronShowerSize",1679,G__dict_457_0_52, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("neutronShowerSize",1822,G__dict_457_0_53, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("muShowerSize",1269,G__dict_457_0_54, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("muCount",747,G__dict_457_0_55, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("hadCount",822,G__dict_457_0_56, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("neutronCount",1300,G__dict_457_0_57, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("gamCount",830,G__dict_457_0_58, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("eleCount",831,G__dict_457_0_59, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aVal", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__dict_457_0_60, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&HGCSSSamplingSection::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__dict_457_0_61, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSSamplingSection::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__dict_457_0_62, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&HGCSSSamplingSection::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__dict_457_0_63, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&HGCSSSamplingSection::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,G__dict_457_0_64, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,G__dict_457_0_65, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,G__dict_457_0_66, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__dict_457_0_67, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__dict_457_0_68, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSSamplingSection::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__dict_457_0_69, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HGCSSSamplingSection::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__dict_457_0_70, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSSamplingSection::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__dict_457_0_71, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HGCSSSamplingSection::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("HGCSSSamplingSection", 1928, G__dict_457_0_72, (int) ('i'), G__get_linked_tagnum(&G__dictLN_HGCSSSamplingSection), -1, 0, 1, 1, 1, 0, "u 'HGCSSSamplingSection' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~HGCSSSamplingSection", 2054, G__dict_457_0_73, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_457_0_74, (int) ('u'), G__get_linked_tagnum(&G__dictLN_HGCSSSamplingSection), -1, 1, 1, 1, 1, 0, "u 'HGCSSSamplingSection' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncvectorlEHGCSSSamplingSectioncOallocatorlEHGCSSSamplingSectiongRsPgR(void) {
   ...
   G__memfunc_setup("at",213,G__dict_459_0_1, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSamplingSection), G__defined_typename("vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("at",213,G__dict_459_0_2, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSamplingSection), G__defined_typename("vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("begin",517,G__dict_459_0_3, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSamplingSectioncOallocatorlEHGCSSSamplingSectiongRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("end",311,G__dict_459_0_4, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSamplingSectioncOallocatorlEHGCSSSamplingSectiongRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rbegin",631,G__dict_459_0_5, 117, G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSSamplingSectioncOallocatorlEHGCSSSamplingSectiongRsPgRcLcLiteratorgR), G__defined_typename("vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rend",425,G__dict_459_0_6, 117, G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSSamplingSectioncOallocatorlEHGCSSSamplingSectiongRsPgRcLcLiteratorgR), G__defined_typename("vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("size",443,G__dict_459_0_7, 107, -1, G__defined_typename("vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("max_size",864,G__dict_459_0_8, 107, -1, G__defined_typename("vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("resize",658,G__dict_459_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::size_type' 0 - sz", (char*)NULL, (void*) NULL, 0);
...
"k - 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::size_type' 0 - sz u 'HGCSSSamplingSection' - 0 - c", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("capacity",846,G__dict_459_0_11, 107, -1, G__defined_typename("vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("empty",559,G__dict_459_0_12, 103, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__dict_459_0_13, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSamplingSection), G__defined_typename("vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__dict_459_0_14, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSamplingSection), G__defined_typename("vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >",5796,G__dict_459_0_15, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSamplingSectioncOallocatorlEHGCSSSamplingSectiongRsPgR), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >",5796,G__dict_459_0_16, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSamplingSectioncOallocatorlEHGCSSSamplingSectiongRsPgR), -1, 0, 2, 1, 1, 0, 
"k - 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::size_type' 0 - n u 'HGCSSSamplingSection' - 11 'HGCSSSamplingSection()' value", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >",5796,G__dict_459_0_17, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSamplingSectioncOallocatorlEHGCSSSamplingSectiongRsPgR), -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >",5796,G__dict_459_0_18, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSamplingSectioncOallocatorlEHGCSSSamplingSectiongRsPgR), -1, 0, 2, 1, 1, 0, 
"u 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::iterator' 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::const_iterator' 10 - first u 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::iterator' 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::const_iterator' 10 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator=",937,G__dict_459_0_19, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSamplingSectioncOallocatorlEHGCSSSamplingSectiongRsPgR), -1, 1, 1, 1, 1, 0, "u 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("reserve",764,G__dict_459_0_20, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("front",553,G__dict_459_0_21, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSamplingSection), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("back",401,G__dict_459_0_22, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSamplingSection), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("push_back",944,G__dict_459_0_23, 121, -1, -1, 0, 1, 1, 1, 0, "u 'HGCSSSamplingSection' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("swap",443,G__dict_459_0_24, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >' - 1 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__dict_459_0_25, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSamplingSectioncOallocatorlEHGCSSSamplingSectiongRsPgRcLcLiterator), -1, 0, 2, 1, 1, 0, 
...
"u 'HGCSSSamplingSection' - 11 - x", (char*)NULL, (void*) NULL, 0);
   ...
   G__memfunc_setup("erase",528,G__dict_459_0_29, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::iterator' - 0 - position", (char*)NULL, (void*) NULL, 0);
...
"u 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::iterator' - 0 - first u 'vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >::iterator' - 0 - last", (char*)NULL, (void*) NULL, 0);
   ...
   // automatic destructor
   G__memfunc_setup("~vector<HGCSSSamplingSection,allocator<HGCSSSamplingSection> >", 5922, G__dict_459_0_32, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncHGCSSSimHit(void) {
   ...
   G__memfunc_setup("HGCSSSimHit",966,G__dict_602_0_1, 105, G__get_linked_tagnum(&G__dictLN_HGCSSSimHit), -1, 0, 0, 5, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("HGCSSSimHit",966,G__dict_602_0_2, 105, G__get_linked_tagnum(&G__dictLN_HGCSSSimHit), -1, 0, 4, 1, 1, 0, 
"u 'G4SiHit' - 11 - aSiHit h - - 11 - asilayer "
"U 'TH2Poly' - 0 - map f - - 10 'CELL_SIZE_X' cellSize", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("energy",650,G__dict_602_0_3, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("time",431,G__dict_602_0_4, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("calculateTime",1341,G__dict_602_0_5, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("layer",541,G__dict_602_0_6, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("silayer",761,G__dict_602_0_7, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setLayer",841,G__dict_602_0_8, 121, -1, -1, 0, 2, 1, 1, 0, 
"h - - 11 - layer h - - 11 - silayer", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("cellid",621,G__dict_602_0_9, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("nGammas",708,G__dict_602_0_10, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("nElectrons",1053,G__dict_602_0_11, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("nMuons",640,G__dict_602_0_12, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("nNeutrons",972,G__dict_602_0_13, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("nProtons",867,G__dict_602_0_14, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("nHadrons",829,G__dict_602_0_15, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("numberOfParticles",1765,G__dict_602_0_16, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("gFrac",483,G__dict_602_0_17, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("eFrac",481,G__dict_602_0_18, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("muFrac",606,G__dict_602_0_19, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("neutronFrac",1159,G__dict_602_0_20, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("protonFrac",1054,G__dict_602_0_21, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("hadFrac",681,G__dict_602_0_22, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Add",265,G__dict_602_0_23, 121, -1, -1, 0, 1, 1, 1, 0, "u 'G4SiHit' - 11 - aSiHit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("get_xy",656,G__dict_602_0_24, 117, G__get_linked_tagnum(&G__dictLN_pairlEdoublecOdoublegR), -1, 0, 2, 1, 1, 8, 
"g - - 10 - isScintillator u 'HGCSSGeometryConversion' - 11 - aGeom", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("position",885,G__dict_602_0_25, 117, G__get_linked_tagnum(&G__dictLN_ROOTcLcLMathcLcLPositionVector3DlEROOTcLcLMathcLcLCartesian3DlEdoublegRcOROOTcLcLMathcLcLDefaultCoordinateSystemTaggR), G__defined_typename("ROOT::Math::XYZPoint"), 0, 2, 1, 1, 8, 
"g - - 10 - isScintillator u 'HGCSSGeometryConversion' - 11 - aGeom", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("get_z",537,G__dict_602_0_26, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("eta",314,G__dict_602_0_27, 100, -1, -1, 0, 2, 1, 1, 8, 
"g - - 10 - isScintillator u 'HGCSSGeometryConversion' - 11 - aGeom", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("theta",534,G__dict_602_0_28, 100, -1, -1, 0, 2, 1, 1, 8, 
"g - - 10 - isScintillator u 'HGCSSGeometryConversion' - 11 - aGeom", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("phi",321,G__dict_602_0_29, 100, -1, -1, 0, 2, 1, 1, 8, 
"g - - 10 - isScintillator u 'HGCSSGeometryConversion' - 11 - aGeom", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getGranularity",1490,G__dict_602_0_30, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("mainParentTrackID",1681,G__dict_602_0_31, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("mainParentEfrac",1520,G__dict_602_0_32, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Print",525,G__dict_602_0_33, 121, -1, -1, 0, 1, 1, 1, 8, "u 'basic_ostream<char,char_traits<char> >' 'ostream' 1 - aOs", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__dict_602_0_34, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&HGCSSSimHit::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__dict_602_0_35, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSSimHit::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__dict_602_0_36, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&HGCSSSimHit::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__dict_602_0_37, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&HGCSSSimHit::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,G__dict_602_0_38, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,G__dict_602_0_39, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,G__dict_602_0_40, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__dict_602_0_41, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__dict_602_0_42, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSSimHit::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__dict_602_0_43, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HGCSSSimHit::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__dict_602_0_44, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSSimHit::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__dict_602_0_45, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HGCSSSimHit::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("HGCSSSimHit", 966, G__dict_602_0_46, (int) ('i'), G__get_linked_tagnum(&G__dictLN_HGCSSSimHit), -1, 0, 1, 1, 1, 0, "u 'HGCSSSimHit' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~HGCSSSimHit", 1092, G__dict_602_0_47, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_602_0_48, (int) ('u'), G__get_linked_tagnum(&G__dictLN_HGCSSSimHit), -1, 1, 1, 1, 1, 0, "u 'HGCSSSimHit' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncvectorlEHGCSSSimHitcOallocatorlEHGCSSSimHitgRsPgR(void) {
   ...
   G__memfunc_setup("at",213,G__dict_604_0_1, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSimHit), G__defined_typename("vector<HGCSSSimHit,allocator<HGCSSSimHit> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("at",213,G__dict_604_0_2, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSimHit), G__defined_typename("vector<HGCSSSimHit,allocator<HGCSSSimHit> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("begin",517,G__dict_604_0_3, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimHitcOallocatorlEHGCSSSimHitgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("end",311,G__dict_604_0_4, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimHitcOallocatorlEHGCSSSimHitgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rbegin",631,G__dict_604_0_5, 117, G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSSimHitcOallocatorlEHGCSSSimHitgRsPgRcLcLiteratorgR), G__defined_typename("vector<HGCSSSimHit,allocator<HGCSSSimHit> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rend",425,G__dict_604_0_6, 117, G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSSimHitcOallocatorlEHGCSSSimHitgRsPgRcLcLiteratorgR), G__defined_typename("vector<HGCSSSimHit,allocator<HGCSSSimHit> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("size",443,G__dict_604_0_7, 107, -1, G__defined_typename("vector<HGCSSSimHit,allocator<HGCSSSimHit> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("max_size",864,G__dict_604_0_8, 107, -1, G__defined_typename("vector<HGCSSSimHit,allocator<HGCSSSimHit> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("resize",658,G__dict_604_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::size_type' 0 - sz", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("resize",658,G__dict_604_0_10, 121, -1, -1, 0, 2, 1, 1, 0, 
"k - 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::size_type' 0 - sz u 'HGCSSSimHit' - 0 - c", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("capacity",846,G__dict_604_0_11, 107, -1, G__defined_typename("vector<HGCSSSimHit,allocator<HGCSSSimHit> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("empty",559,G__dict_604_0_12, 103, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__dict_604_0_13, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSimHit), G__defined_typename("vector<HGCSSSimHit,allocator<HGCSSSimHit> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__dict_604_0_14, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSimHit), G__defined_typename("vector<HGCSSSimHit,allocator<HGCSSSimHit> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSSimHit,allocator<HGCSSSimHit> >",3872,G__dict_604_0_15, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimHitcOallocatorlEHGCSSSimHitgRsPgR), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSSimHit,allocator<HGCSSSimHit> >",3872,G__dict_604_0_16, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimHitcOallocatorlEHGCSSSimHitgRsPgR), -1, 0, 2, 1, 1, 0, 
"k - 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::size_type' 0 - n u 'HGCSSSimHit' - 11 'HGCSSSimHit()' value", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSSimHit,allocator<HGCSSSimHit> >",3872,G__dict_604_0_17, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimHitcOallocatorlEHGCSSSimHitgRsPgR), -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSSimHit,allocator<HGCSSSimHit> >",3872,G__dict_604_0_18, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimHitcOallocatorlEHGCSSSimHitgRsPgR), -1, 0, 2, 1, 1, 0, 
"u 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::iterator' 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::const_iterator' 10 - first u 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::iterator' 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::const_iterator' 10 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator=",937,G__dict_604_0_19, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimHitcOallocatorlEHGCSSSimHitgRsPgR), -1, 1, 1, 1, 1, 0, "u 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("reserve",764,G__dict_604_0_20, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("front",553,G__dict_604_0_21, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSimHit), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("back",401,G__dict_604_0_22, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSimHit), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("push_back",944,G__dict_604_0_23, 121, -1, -1, 0, 1, 1, 1, 0, "u 'HGCSSSimHit' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("swap",443,G__dict_604_0_24, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >' - 1 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__dict_604_0_25, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimHitcOallocatorlEHGCSSSimHitgRsPgRcLcLiterator), -1, 0, 2, 1, 1, 0, 
"u 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::iterator' - 0 - position u 'HGCSSSimHit' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__dict_604_0_26, 121, -1, -1, 0, 3, 1, 1, 0, 
...
"u 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::iterator' 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::const_iterator' 10 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__dict_604_0_27, 121, -1, -1, 0, 3, 1, 1, 0, 
...
"u 'HGCSSSimHit' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("pop_back",831,G__dict_604_0_28, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("erase",528,G__dict_604_0_29, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::iterator' - 0 - position", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("erase",528,G__dict_604_0_30, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::iterator' - 0 - first u 'vector<HGCSSSimHit,allocator<HGCSSSimHit> >::iterator' - 0 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("clear",519,G__dict_604_0_31, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~vector<HGCSSSimHit,allocator<HGCSSSimHit> >", 3998, G__dict_604_0_32, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncHGCSSGenParticle(void) {
   ...
   G__memfunc_setup("HGCSSGenParticle",1478,G__dict_607_0_1, 105, G__get_linked_tagnum(&G__dictLN_HGCSSGenParticle), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("mass",436,G__dict_607_0_2, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("time",431,G__dict_607_0_3, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("x",120,G__dict_607_0_4, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("y",121,G__dict_607_0_5, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("z",122,G__dict_607_0_6, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("px",232,G__dict_607_0_7, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("py",233,G__dict_607_0_8, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("pz",234,G__dict_607_0_9, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("pdgid",520,G__dict_607_0_10, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("charge",618,G__dict_607_0_11, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("trackID",674,G__dict_607_0_12, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("layer",541,G__dict_607_0_13, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("pt",228,G__dict_607_0_14, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("p",112,G__dict_607_0_15, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("E",69,G__dict_607_0_16, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("parentPdgId",1106,G__dict_607_0_17, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("parentKE",794,G__dict_607_0_18, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("eta",314,G__dict_607_0_19, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("theta",534,G__dict_607_0_20, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("phi",321,G__dict_607_0_21, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setPosition",1185,G__dict_607_0_22, 121, -1, -1, 0, 3, 1, 1, 0, 
"d - - 11 - x d - - 11 - y "
"d - - 11 - z", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setMomentum",1182,G__dict_607_0_23, 121, -1, -1, 0, 3, 1, 1, 0, 
"d - - 11 - px d - - 11 - py "
"d - - 11 - pz", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("mass",436,G__dict_607_0_24, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("time",431,G__dict_607_0_25, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("pdgid",520,G__dict_607_0_26, 121, -1, -1, 0, 1, 1, 1, 0, "i - - 11 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("charge",618,G__dict_607_0_27, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vertexKE",814,G__dict_607_0_28, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("finalKE",666,G__dict_607_0_29, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vertexPos",976,G__dict_607_0_30, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TVector3' - 1 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vertexMom",967,G__dict_607_0_31, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TVector3' - 1 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("trackID",674,G__dict_607_0_32, 121, -1, -1, 0, 1, 1, 1, 0, "i - - 11 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("layer",541,G__dict_607_0_33, 121, -1, -1, 0, 1, 1, 1, 0, "i - - 11 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("parentPdgId",1106,G__dict_607_0_34, 121, -1, -1, 0, 1, 1, 1, 0, "i - - 11 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("parentKE",794,G__dict_607_0_35, 121, -1, -1, 0, 1, 1, 1, 0, "i - - 11 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vertexKE",814,G__dict_607_0_36, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("finalKE",666,G__dict_607_0_37, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vertexPos",976,G__dict_607_0_38, 117, G__get_linked_tagnum(&G__dictLN_TVector3), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vertexMom",967,G__dict_607_0_39, 117, G__get_linked_tagnum(&G__dictLN_TVector3), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("isIncoming",1040,G__dict_607_0_40, 103, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Print",525,G__dict_607_0_41, 121, -1, -1, 0, 1, 1, 1, 8, "u 'basic_ostream<char,char_traits<char> >' 'ostream' 1 - aOs", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Print",525,G__dict_607_0_42, 121, -1, -1, 0, 2, 1, 1, 8, 
"h - - 10 - - u 'basic_ostream<char,char_traits<char> >' 'ostream' 1 - aOs", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__dict_607_0_43, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&HGCSSGenParticle::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__dict_607_0_44, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSGenParticle::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__dict_607_0_45, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&HGCSSGenParticle::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__dict_607_0_46, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&HGCSSGenParticle::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,G__dict_607_0_47, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,G__dict_607_0_48, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,G__dict_607_0_49, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__dict_607_0_50, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__dict_607_0_51, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSGenParticle::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__dict_607_0_52, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HGCSSGenParticle::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__dict_607_0_53, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSGenParticle::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__dict_607_0_54, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HGCSSGenParticle::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("HGCSSGenParticle", 1478, G__dict_607_0_55, (int) ('i'), G__get_linked_tagnum(&G__dictLN_HGCSSGenParticle), -1, 0, 1, 1, 1, 0, "u 'HGCSSGenParticle' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~HGCSSGenParticle", 1604, G__dict_607_0_56, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_607_0_57, (int) ('u'), G__get_linked_tagnum(&G__dictLN_HGCSSGenParticle), -1, 1, 1, 1, 1, 0, "u 'HGCSSGenParticle' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncvectorlEHGCSSGenParticlecOallocatorlEHGCSSGenParticlegRsPgR(void) {
   ...
   G__memfunc_setup("at",213,G__dict_609_0_1, 117, G__get_linked_tagnum(&G__dictLN_HGCSSGenParticle), G__defined_typename("vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("at",213,G__dict_609_0_2, 117, G__get_linked_tagnum(&G__dictLN_HGCSSGenParticle), G__defined_typename("vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("begin",517,G__dict_609_0_3, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSGenParticlecOallocatorlEHGCSSGenParticlegRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("end",311,G__dict_609_0_4, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSGenParticlecOallocatorlEHGCSSGenParticlegRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rbegin",631,G__dict_609_0_5, 117, G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSGenParticlecOallocatorlEHGCSSGenParticlegRsPgRcLcLiteratorgR), G__defined_typename("vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rend",425,G__dict_609_0_6, 117, G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSGenParticlecOallocatorlEHGCSSGenParticlegRsPgRcLcLiteratorgR), G__defined_typename("vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("size",443,G__dict_609_0_7, 107, -1, G__defined_typename("vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("max_size",864,G__dict_609_0_8, 107, -1, G__defined_typename("vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("resize",658,G__dict_609_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::size_type' 0 - sz", (char*)NULL, (void*) NULL, 0);
...
"k - 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::size_type' 0 - sz u 'HGCSSGenParticle' - 0 - c", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("capacity",846,G__dict_609_0_11, 107, -1, G__defined_typename("vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("empty",559,G__dict_609_0_12, 103, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__dict_609_0_13, 117, G__get_linked_tagnum(&G__dictLN_HGCSSGenParticle), G__defined_typename("vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__dict_609_0_14, 117, G__get_linked_tagnum(&G__dictLN_HGCSSGenParticle), G__defined_typename("vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >",4896,G__dict_609_0_15, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSGenParticlecOallocatorlEHGCSSGenParticlegRsPgR), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >",4896,G__dict_609_0_16, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSGenParticlecOallocatorlEHGCSSGenParticlegRsPgR), -1, 0, 2, 1, 1, 0, 
"k - 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::size_type' 0 - n u 'HGCSSGenParticle' - 11 'HGCSSGenParticle()' value", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >",4896,G__dict_609_0_17, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSGenParticlecOallocatorlEHGCSSGenParticlegRsPgR), -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >",4896,G__dict_609_0_18, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSGenParticlecOallocatorlEHGCSSGenParticlegRsPgR), -1, 0, 2, 1, 1, 0, 
"u 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::iterator' 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::const_iterator' 10 - first u 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::iterator' 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::const_iterator' 10 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator=",937,G__dict_609_0_19, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSGenParticlecOallocatorlEHGCSSGenParticlegRsPgR), -1, 1, 1, 1, 1, 0, "u 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("reserve",764,G__dict_609_0_20, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("front",553,G__dict_609_0_21, 117, G__get_linked_tagnum(&G__dictLN_HGCSSGenParticle), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("back",401,G__dict_609_0_22, 117, G__get_linked_tagnum(&G__dictLN_HGCSSGenParticle), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("push_back",944,G__dict_609_0_23, 121, -1, -1, 0, 1, 1, 1, 0, "u 'HGCSSGenParticle' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("swap",443,G__dict_609_0_24, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >' - 1 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__dict_609_0_25, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSGenParticlecOallocatorlEHGCSSGenParticlegRsPgRcLcLiterator), -1, 0, 2, 1, 1, 0, 
...
"u 'HGCSSGenParticle' - 11 - x", (char*)NULL, (void*) NULL, 0);
   ...
   G__memfunc_setup("erase",528,G__dict_609_0_29, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::iterator' - 0 - position", (char*)NULL, (void*) NULL, 0);
...
"u 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::iterator' - 0 - first u 'vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >::iterator' - 0 - last", (char*)NULL, (void*) NULL, 0);
   ...
   // automatic destructor
   G__memfunc_setup("~vector<HGCSSGenParticle,allocator<HGCSSGenParticle> >", 5022, G__dict_609_0_32, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncHGCSSRecoHit(void) {
   ...
   G__memfunc_setup("HGCSSRecoHit",1062,G__dict_612_0_1, 105, G__get_linked_tagnum(&G__dictLN_HGCSSRecoHit), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("HGCSSRecoHit",1062,G__dict_612_0_2, 105, G__get_linked_tagnum(&G__dictLN_HGCSSRecoHit), -1, 0, 3, 1, 1, 0, 
"u 'HGCSSSimHit' - 11 - aSimHit g - - 10 - isScintillator "
"u 'HGCSSGeometryConversion' - 11 - aGeom", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("energy",650,G__dict_612_0_3, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("time",431,G__dict_612_0_4, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("eta",314,G__dict_612_0_5, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("theta",534,G__dict_612_0_6, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("phi",321,G__dict_612_0_7, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("position",885,G__dict_612_0_8, 117, G__get_linked_tagnum(&G__dictLN_ROOTcLcLMathcLcLPositionVector3DlEROOTcLcLMathcLcLCartesian3DlEdoublegRcOROOTcLcLMathcLcLDefaultCoordinateSystemTaggR), G__defined_typename("ROOT::Math::XYZPoint"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("E",69,G__dict_612_0_9, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("pt",228,G__dict_612_0_10, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("px",232,G__dict_612_0_11, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("py",233,G__dict_612_0_12, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("pz",234,G__dict_612_0_13, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("energy",650,G__dict_612_0_14, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - energy", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("time",431,G__dict_612_0_15, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - time", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("x",120,G__dict_612_0_16, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - pos", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("y",121,G__dict_612_0_17, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - pos", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("z",122,G__dict_612_0_18, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - pos", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("adcCounts",932,G__dict_612_0_19, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("adcCounts",932,G__dict_612_0_20, 121, -1, -1, 0, 1, 1, 1, 0, "h - - 11 - adcCounts", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("layer",541,G__dict_612_0_21, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("layer",541,G__dict_612_0_22, 121, -1, -1, 0, 1, 1, 1, 0, "h - - 11 - layer", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("noiseFraction",1364,G__dict_612_0_23, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("noiseFraction",1364,G__dict_612_0_24, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aFrac", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Add",265,G__dict_612_0_25, 121, -1, -1, 0, 1, 1, 1, 0, "u 'HGCSSSimHit' - 11 - aSimHit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("get_x",535,G__dict_612_0_26, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("get_y",536,G__dict_612_0_27, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("get_z",537,G__dict_612_0_28, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Print",525,G__dict_612_0_29, 121, -1, -1, 0, 1, 1, 1, 8, "u 'basic_ostream<char,char_traits<char> >' 'ostream' 1 - aOs", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__dict_612_0_30, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&HGCSSRecoHit::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__dict_612_0_31, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSRecoHit::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__dict_612_0_32, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&HGCSSRecoHit::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__dict_612_0_33, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&HGCSSRecoHit::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,G__dict_612_0_34, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,G__dict_612_0_35, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,G__dict_612_0_36, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__dict_612_0_37, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__dict_612_0_38, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSRecoHit::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__dict_612_0_39, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HGCSSRecoHit::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__dict_612_0_40, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSRecoHit::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__dict_612_0_41, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HGCSSRecoHit::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("HGCSSRecoHit", 1062, G__dict_612_0_42, (int) ('i'), G__get_linked_tagnum(&G__dictLN_HGCSSRecoHit), -1, 0, 1, 1, 1, 0, "u 'HGCSSRecoHit' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~HGCSSRecoHit", 1188, G__dict_612_0_43, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_612_0_44, (int) ('u'), G__get_linked_tagnum(&G__dictLN_HGCSSRecoHit), -1, 1, 1, 1, 1, 0, "u 'HGCSSRecoHit' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncvectorlEHGCSSRecoHitcOallocatorlEHGCSSRecoHitgRsPgR(void) {
   ...
   G__memfunc_setup("at",213,G__dict_614_0_1, 117, G__get_linked_tagnum(&G__dictLN_HGCSSRecoHit), G__defined_typename("vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("at",213,G__dict_614_0_2, 117, G__get_linked_tagnum(&G__dictLN_HGCSSRecoHit), G__defined_typename("vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("begin",517,G__dict_614_0_3, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoHitcOallocatorlEHGCSSRecoHitgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("end",311,G__dict_614_0_4, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoHitcOallocatorlEHGCSSRecoHitgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rbegin",631,G__dict_614_0_5, 117, G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSRecoHitcOallocatorlEHGCSSRecoHitgRsPgRcLcLiteratorgR), G__defined_typename("vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rend",425,G__dict_614_0_6, 117, G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSRecoHitcOallocatorlEHGCSSRecoHitgRsPgRcLcLiteratorgR), G__defined_typename("vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("size",443,G__dict_614_0_7, 107, -1, G__defined_typename("vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("max_size",864,G__dict_614_0_8, 107, -1, G__defined_typename("vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("resize",658,G__dict_614_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::size_type' 0 - sz", (char*)NULL, (void*) NULL, 0);
...
"k - 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::size_type' 0 - sz u 'HGCSSRecoHit' - 0 - c", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("capacity",846,G__dict_614_0_11, 107, -1, G__defined_typename("vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("empty",559,G__dict_614_0_12, 103, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__dict_614_0_13, 117, G__get_linked_tagnum(&G__dictLN_HGCSSRecoHit), G__defined_typename("vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__dict_614_0_14, 117, G__get_linked_tagnum(&G__dictLN_HGCSSRecoHit), G__defined_typename("vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >",4064,G__dict_614_0_15, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoHitcOallocatorlEHGCSSRecoHitgRsPgR), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >",4064,G__dict_614_0_16, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoHitcOallocatorlEHGCSSRecoHitgRsPgR), -1, 0, 2, 1, 1, 0, 
"k - 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::size_type' 0 - n u 'HGCSSRecoHit' - 11 'HGCSSRecoHit()' value", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >",4064,G__dict_614_0_17, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoHitcOallocatorlEHGCSSRecoHitgRsPgR), -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >",4064,G__dict_614_0_18, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoHitcOallocatorlEHGCSSRecoHitgRsPgR), -1, 0, 2, 1, 1, 0, 
"u 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::iterator' 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::const_iterator' 10 - first u 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::iterator' 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::const_iterator' 10 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator=",937,G__dict_614_0_19, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoHitcOallocatorlEHGCSSRecoHitgRsPgR), -1, 1, 1, 1, 1, 0, "u 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("reserve",764,G__dict_614_0_20, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("front",553,G__dict_614_0_21, 117, G__get_linked_tagnum(&G__dictLN_HGCSSRecoHit), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("back",401,G__dict_614_0_22, 117, G__get_linked_tagnum(&G__dictLN_HGCSSRecoHit), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("push_back",944,G__dict_614_0_23, 121, -1, -1, 0, 1, 1, 1, 0, "u 'HGCSSRecoHit' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("swap",443,G__dict_614_0_24, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >' - 1 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__dict_614_0_25, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoHitcOallocatorlEHGCSSRecoHitgRsPgRcLcLiterator), -1, 0, 2, 1, 1, 0, 
...
"u 'HGCSSRecoHit' - 11 - x", (char*)NULL, (void*) NULL, 0);
   ...
   G__memfunc_setup("erase",528,G__dict_614_0_29, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::iterator' - 0 - position", (char*)NULL, (void*) NULL, 0);
...
"u 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::iterator' - 0 - first u 'vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >::iterator' - 0 - last", (char*)NULL, (void*) NULL, 0);
   ...
   // automatic destructor
   G__memfunc_setup("~vector<HGCSSRecoHit,allocator<HGCSSRecoHit> >", 4190, G__dict_614_0_32, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncHGCSSRecoJet(void) {
   ...
   G__memfunc_setup("HGCSSRecoJet",1060,G__dict_617_0_1, 105, G__get_linked_tagnum(&G__dictLN_HGCSSRecoJet), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("HGCSSRecoJet",1060,G__dict_617_0_2, 105, G__get_linked_tagnum(&G__dictLN_HGCSSRecoJet), -1, 0, 4, 1, 1, 0, 
"d - - 11 - px d - - 11 - py "
"d - - 11 - pz d - - 11 - E", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("energy",650,G__dict_617_0_3, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("E",69,G__dict_617_0_4, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("energy",650,G__dict_617_0_5, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - energy", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("px",232,G__dict_617_0_6, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("py",233,G__dict_617_0_7, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("pz",234,G__dict_617_0_8, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("area",409,G__dict_617_0_9, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("area",409,G__dict_617_0_10, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aArea", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("area_error",1058,G__dict_617_0_11, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("area_error",1058,G__dict_617_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - aErr", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("nConstituents",1409,G__dict_617_0_13, 104, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("nConstituents",1409,G__dict_617_0_14, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 10 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Print",525,G__dict_617_0_15, 121, -1, -1, 0, 1, 1, 1, 8, "u 'basic_ostream<char,char_traits<char> >' 'ostream' 1 - aOs", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__dict_617_0_16, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&HGCSSRecoJet::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__dict_617_0_17, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSRecoJet::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__dict_617_0_18, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&HGCSSRecoJet::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__dict_617_0_19, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&HGCSSRecoJet::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,G__dict_617_0_20, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,G__dict_617_0_21, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,G__dict_617_0_22, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__dict_617_0_23, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__dict_617_0_24, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSRecoJet::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__dict_617_0_25, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HGCSSRecoJet::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__dict_617_0_26, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSRecoJet::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__dict_617_0_27, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HGCSSRecoJet::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("HGCSSRecoJet", 1060, G__dict_617_0_28, (int) ('i'), G__get_linked_tagnum(&G__dictLN_HGCSSRecoJet), -1, 0, 1, 1, 1, 0, "u 'HGCSSRecoJet' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~HGCSSRecoJet", 1186, G__dict_617_0_29, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_617_0_30, (int) ('u'), G__get_linked_tagnum(&G__dictLN_HGCSSRecoJet), -1, 1, 1, 1, 1, 0, "u 'HGCSSRecoJet' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncvectorlEHGCSSRecoJetcOallocatorlEHGCSSRecoJetgRsPgR(void) {
   ...
   G__memfunc_setup("at",213,G__dict_619_0_1, 117, G__get_linked_tagnum(&G__dictLN_HGCSSRecoJet), G__defined_typename("vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("at",213,G__dict_619_0_2, 117, G__get_linked_tagnum(&G__dictLN_HGCSSRecoJet), G__defined_typename("vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("begin",517,G__dict_619_0_3, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoJetcOallocatorlEHGCSSRecoJetgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("end",311,G__dict_619_0_4, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoJetcOallocatorlEHGCSSRecoJetgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rbegin",631,G__dict_619_0_5, 117, G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSRecoJetcOallocatorlEHGCSSRecoJetgRsPgRcLcLiteratorgR), G__defined_typename("vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rend",425,G__dict_619_0_6, 117, G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSRecoJetcOallocatorlEHGCSSRecoJetgRsPgRcLcLiteratorgR), G__defined_typename("vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("size",443,G__dict_619_0_7, 107, -1, G__defined_typename("vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("max_size",864,G__dict_619_0_8, 107, -1, G__defined_typename("vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("resize",658,G__dict_619_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::size_type' 0 - sz", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("resize",658,G__dict_619_0_10, 121, -1, -1, 0, 2, 1, 1, 0, 
"k - 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::size_type' 0 - sz u 'HGCSSRecoJet' - 0 - c", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("capacity",846,G__dict_619_0_11, 107, -1, G__defined_typename("vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("empty",559,G__dict_619_0_12, 103, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__dict_619_0_13, 117, G__get_linked_tagnum(&G__dictLN_HGCSSRecoJet), G__defined_typename("vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__dict_619_0_14, 117, G__get_linked_tagnum(&G__dictLN_HGCSSRecoJet), G__defined_typename("vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >",4060,G__dict_619_0_15, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoJetcOallocatorlEHGCSSRecoJetgRsPgR), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >",4060,G__dict_619_0_16, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoJetcOallocatorlEHGCSSRecoJetgRsPgR), -1, 0, 2, 1, 1, 0, 
"k - 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::size_type' 0 - n u 'HGCSSRecoJet' - 11 'HGCSSRecoJet()' value", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >",4060,G__dict_619_0_17, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoJetcOallocatorlEHGCSSRecoJetgRsPgR), -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >",4060,G__dict_619_0_18, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoJetcOallocatorlEHGCSSRecoJetgRsPgR), -1, 0, 2, 1, 1, 0, 
"u 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::iterator' 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::const_iterator' 10 - first u 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::iterator' 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::const_iterator' 10 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator=",937,G__dict_619_0_19, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoJetcOallocatorlEHGCSSRecoJetgRsPgR), -1, 1, 1, 1, 1, 0, "u 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("reserve",764,G__dict_619_0_20, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("front",553,G__dict_619_0_21, 117, G__get_linked_tagnum(&G__dictLN_HGCSSRecoJet), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("back",401,G__dict_619_0_22, 117, G__get_linked_tagnum(&G__dictLN_HGCSSRecoJet), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("push_back",944,G__dict_619_0_23, 121, -1, -1, 0, 1, 1, 1, 0, "u 'HGCSSRecoJet' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("swap",443,G__dict_619_0_24, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >' - 1 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__dict_619_0_25, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSRecoJetcOallocatorlEHGCSSRecoJetgRsPgRcLcLiterator), -1, 0, 2, 1, 1, 0, 
"u 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::iterator' - 0 - position u 'HGCSSRecoJet' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__dict_619_0_26, 121, -1, -1, 0, 3, 1, 1, 0, 
...
"u 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::iterator' 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::const_iterator' 10 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__dict_619_0_27, 121, -1, -1, 0, 3, 1, 1, 0, 
...
"u 'HGCSSRecoJet' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("pop_back",831,G__dict_619_0_28, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("erase",528,G__dict_619_0_29, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::iterator' - 0 - position", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("erase",528,G__dict_619_0_30, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::iterator' - 0 - first u 'vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >::iterator' - 0 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("clear",519,G__dict_619_0_31, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~vector<HGCSSRecoJet,allocator<HGCSSRecoJet> >", 4186, G__dict_619_0_32, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncHGCSSCluster(void) {
   ...
   G__memfunc_setup("HGCSSCluster",1114,G__dict_645_0_1, 105, G__get_linked_tagnum(&G__dictLN_HGCSSCluster), -1, 0, 0, 5, 1, 0, "", (char*)NULL, (void*) NULL, 0);
